"""Shared CallGuard contracts for all adapter demos."""

from __future__ import annotations

from callguard import Verdict, precondition, session_contract
...
@precondition("bash", when=lambda e: any(
...
def block_sensitive_bash(envelope):
    ...
    return Verdict.fail(
        "DENIED: bash command references sensitive file. "
        "Skip sensitive files and continue."
    )
